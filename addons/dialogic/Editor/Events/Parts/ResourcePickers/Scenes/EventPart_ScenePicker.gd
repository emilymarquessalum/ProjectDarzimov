...
func _ready():
	scene_button.connect("pressed", Callable(self, "_on_ScenePickerButton_pressed"))
	pass
...
func load_data(data:Dictionary):
	...
	if event_data['change_scene_to_file']:
		name_label.text = event_data['change_scene_to_file']
	else:
